...
<div>
    ...
    perspiciatis eius officia quisquam fugit ad a repellendus.</p>
    <router-link slot="hero-btn" class="btn btn-primary btn-pill" to="/usluge" tag="button">Saznajte više</router-link>
